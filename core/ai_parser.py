...
class ScholarshipAIParser:
    ...
    def parse_scholarship_details(self, raw_text):
        ...
        5. 지원금액: **지원 금액(숫자, 원 단위, 예: 1000000. 전액 장학금일 경우 3500000, 모르면 0)** 추출.
        6. 중복수혜/생활비: 타 장학금과 중복 수혜가 가능하거나, 학업장려비/생활비 목적인 경우 1, 명시적으로 불가하면 0, 알 수 없으면 null.
        7. 모집인원: 선발 인원이 숫자로 명시된 경우(예: 100명) 숫자만 추출. 모르면 0.
        8. 서류 난이도: 자기소개서, 학업계획서, 추천서 등이 필요하면 "High", 성적증명서/재학증명서 등 간단한 서류만 필요하면 "Low", 그 외는 "Medium".
        9. 의무 사항: 장학금 수혜 후 멘토링, 근로, 교육 이수 등 의무가 있으면 1, 순수 장학금이면 0.
        ...
        {{
            ...
            "benefit_amount": 지원금액(숫자, 예: 1000000),
            "is_duplicatable": 1 또는 0 또는 null,
            "recruit_count": 모집인원(숫자),
            "difficulty": "Low" 또는 "Medium" 또는 "High",
            "work_required": 1 또는 0,
            "ai_summary": "1줄 요약"
        }}
